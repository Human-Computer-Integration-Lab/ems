...
#         print(
#             "Rehamove Version: Python-side "
#             + str(Rehamove.current_version)
#             + ", C-side "
#             + str(c_version)
#         )
...
#             return "Rehamove device in low-level mode. Mid-level pulse is set to {} mA and {} us.".format(
#                 current, pulse_width
#             )
#         elif mode == Rehamove.MODE_MID_LEVEL:
#             return "Rehamove device in mid-level mode. Mid-level pulse is set to {} mA and {} us.".format(
#                 current, pulse_width
#             )
#         else:
...
#         if self.rehamove is None:
#             print(
#                 "python Rehamove custom_pulse() ERROR! Rehamove object does not exist."
#             )
#             return -1
#         chosen_channel = self.get_channel(channel)
...
#         if num_points > 16:
#             print(
#                 "python Rehamove custom_pulse() WARNING! Maximum of 16 points allowed, truncating points array."
#             )
#             num_points = 16
#
...
#         except IndexError:
#             print(
#                 "python Rehamove custom_pulse() ERROR! Malformed points array, should be: [ (current0, pulse_width0), (current1, pulse_width1), ... ]"
#             )
#             return -1
#
...
#
#         result = rehamovelib.custom_pulse(
#             self.rehamove,
#             chosen_channel,
#             original_length,
#             c0,
...
#         if self.rehamove is None:
#             print(
#                 "python Rehamove change_mode() ERROR! Rehamove object does not exist."
#             )
#             return -1
...
#         else:
#             print(
#                 "python Rehamove set_pulse(): Set pulse current to "
#                 + str(current)
#                 + " and pulse width to "
#                 + str(pulse_width)
#                 + "."
...
#             return -1
#         chosen_channel = self.get_channel(channel)
#         result = rehamovelib.run(
#             self.rehamove, chosen_channel, period, total_milliseconds
#         )
#         if result != 0:
