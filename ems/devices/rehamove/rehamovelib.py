...
class RehamoveDevice(object):
    ...
    __repr__ = _swig_repr
    device = property(
        _rehamovelib.RehamoveDevice_device_get, _rehamovelib.RehamoveDevice_device_set
    )
    battery = property(
        _rehamovelib.RehamoveDevice_battery_get, _rehamovelib.RehamoveDevice_battery_set
    )
    mode = property(
        _rehamovelib.RehamoveDevice_mode_get, _rehamovelib.RehamoveDevice_mode_set
    )
    current = property(
        _rehamovelib.RehamoveDevice_current_get, _rehamovelib.RehamoveDevice_current_set
    )
    pulse_width = property(
        _rehamovelib.RehamoveDevice_pulse_width_get,
        _rehamovelib.RehamoveDevice_pulse_width_set,
    )
...
def custom_pulse(
    ...
    return _rehamovelib.custom_pulse(
        r,
        channel,
        num_points,
        c0,
